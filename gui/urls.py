...
urlpatterns = patterns('',
	...
	#url(r'^$', 'sven.anta.views.index', name='gui_index'),
	#url(r'^login/$', 'sven.anta.views.login_view', name='gui_login'),
	#url(r'^logout/$', 'sven.anta.views.logout_view', name='gui_logout'),
