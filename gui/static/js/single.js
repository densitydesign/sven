...
query.getRelations(function(response){
	...
	d3.select("#deleteAlert .modal-header h3").text("Delete relation?")
	d3.select("#deleteAlert .modal-message").text("These relation will be permanently deleted and cannot be recovered. Are you sure?")
